// Zod schemas shared between the Astro content-collection config
// (src/content.config.ts) and the standalone content validator
// (scripts/validate-content.mjs). Kept in one place so both always agree on
